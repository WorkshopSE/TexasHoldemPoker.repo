...
namespace Poker.BE.Domain.Game.Tests
{
    ...
    public class PickAWinnerTests
    {
        ...
        public void GetWinnerTest()
        {
            ...
            player1.PrivateCards = new Card[2] { new Card(37, Card.Suit.Hearts, Card.Value.Queen), new Card(28, Card.Suit.Hearts, Card.Value.Three) };
            player2.PrivateCards = new Card[2] { new Card(33, Card.Suit.Hearts, Card.Value.Eight), new Card(47, Card.Suit.Spades, Card.Value.Nine) };
            ...
            players.Add(player2);
            players.Add(player3);
            Card card1 = new Card(7, Card.Suit.Clubs, Card.Value.Eight);
            Card card2 = new Card(38, Card.Suit.Hearts, Card.Value.King);
            Card card3 = new Card(35, Card.Suit.Hearts, Card.Value.Ten);
            Card card4 = new Card(21, Card.Suit.Diamonds, Card.Value.Nine);
            Card card5 = new Card(34, Card.Suit.Hearts, Card.Value.Nine);
            ...
            player1.PrivateCards = new Card[2] { new Card(39, Card.Suit.Spades, Card.Value.Ace), new Card(27, Card.Suit.Hearts, Card.Value.Two) };
            player2.PrivateCards = new Card[2] { new Card(0, Card.Suit.Clubs, Card.Value.Ace), new Card(6, Card.Suit.Clubs, Card.Value.Seven) };
            ...
            player1.PrivateCards = new Card[2] { new Card(45, Card.Suit.Spades, Card.Value.Seven), new Card(5, Card.Suit.Clubs, Card.Value.Six) };
            pickAWinner = new PickAWinner(players, tableCards);
            winners = pickAWinner.GetWinners();
            var res5 = winners.Count == 1 && winners.ElementAt(0).Nickname == "a";

            player3.PrivateCards = new Card[2] { new Card(26, Card.Suit.Hearts, Card.Value.Ace), new Card(36, Card.Suit.Hearts, Card.Value.Jack) };
            pickAWinner = new PickAWinner(players, tableCards);
            winners = pickAWinner.GetWinners();
            var res6 = winners.Count == 1 && winners.ElementAt(0).Nickname == "c";

            player2.PrivateCards = new Card[2] { new Card(47, Card.Suit.Spades, Card.Value.Nine), new Card(8, Card.Suit.Clubs, Card.Value.Nine) };
            pickAWinner = new PickAWinner(players, tableCards);
            winners = pickAWinner.GetWinners();
            var res7 = winners.Count == 1 && winners.ElementAt(0).Nickname == "b";

            player1.PrivateCards = new Card[2] { new Card(37, Card.Suit.Hearts, Card.Value.Queen), new Card(36, Card.Suit.Hearts, Card.Value.Jack) };
            pickAWinner = new PickAWinner(players, tableCards);
            winners = pickAWinner.GetWinners();
